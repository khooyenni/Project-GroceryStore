...
public class Employee extends JFrame {
    ...
    String gender = "  ";
   	...
   	if (male.isSelected()) {
		...
		lblNewLabel.setIcon(new ImageIcon(Employee.class.getResource("/BeveragesIcons/employee icon.png")));
		...
		lblNewLabel_2.setIcon(new ImageIcon(Employee.class.getResource("/BeveragesIcons/employee details background.jpg")));
		lblNewLabel_2.setBounds(0, -43, 689, 412);
		panel.add(lblNewLabel_2);
		
		JLabel lblNewLabel_3 = new JLabel("");
		lblNewLabel_3.setIcon(new ImageIcon(Employee.class.getResource("/BeveragesIcons/employee details background.jpg")));
		lblNewLabel_3.setBounds(0, 238, 751, 266);
		panel.add(lblNewLabel_3);
		
		JLabel lblNewLabel_5 = new JLabel("");
		lblNewLabel_5.setIcon(new ImageIcon(Employee.class.getResource("/BeveragesIcons/employee details background.jpg")));
		lblNewLabel_5.setBounds(661, 260, 229, 244);
		panel.add(lblNewLabel_5);
		
		JLabel lblNewLabel_4 = new JLabel("");
		lblNewLabel_4.setIcon(new ImageIcon(Employee.class.getResource("/BeveragesIcons/employee details background.jpg")));
