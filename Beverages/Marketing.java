...
public class Marketing extends JFrame {
	...
	public Marketing() {
		...
		lblNewLabel_1.setIcon(new ImageIcon(Marketing.class.getResource("/BeveragesIcons/marketing Instagram-icon.png")));
		lblNewLabel_1.setBounds(493, 42, 62, 57);
		panel_1_2_1.add(lblNewLabel_1);
		
		JLabel lblNewLabel_2 = new JLabel("");
		lblNewLabel_2.setIcon(new ImageIcon(Marketing.class.getResource("/BeveragesIcons/marketing fb icon.png")));
