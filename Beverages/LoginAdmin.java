...
public class LoginAdmin extends JFrame {
	...
	public LoginAdmin() {
		...
		btnReset.setBounds(292, 400, 171, 32);
		panel.add(btnReset);
		...
		lblNewLabel.setBounds(186, 64, 482, 427);
		lblNewLabel.setIcon(new ImageIcon(LoginAdmin.class.getResource("/BeveragesIcons/customer & admin log in.jpg")));
