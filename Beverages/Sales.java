...
public class Sales extends JFrame {
	...
	public void my_updatee(String tot, String sub) { // overloading with 2 parameters
														// pass value of total price and subtotal price
		total.setText(tot);
		salesbox.setText(sub);
	}

	public void my_updatee(String spend) { // overloading with 1 parameters
											// pass value of total inventory spending from inventory class
		spendingbox.setText(spend);
	...
	public Sales() {// constructor without argument
		...
		spendingbox.setBounds(219, 116, 110, 20);
		...
		panel_1_1_2.setBounds(10, 206, 186, 51);
		...
		chargebox.setBounds(219, 161, 110, 20);
		panel.add(chargebox);

		salesbox = new JTextField();
		salesbox.setColumns(10);
		salesbox.setBounds(219, 206, 110, 20);
		panel.add(salesbox);

		profittext = new JTextField();
		profittext.setColumns(10);
		profittext.setBounds(219, 321, 110, 20);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				model.addRow(new Object[] { spendingbox.getText(), chargebox.getText(), reconfirmsale.getText(),
						profittext.getText(),
				...
				if (table.getSelectedRow() == -1) {
					if (table.getRowCount() == 0) {
						JOptionPane.showMessageDialog(null, "Sales Information updated confirmed",
								"Sales Information System", JOptionPane.OK_OPTION);
					}
				}
			}
		});
		...
		btnDelete.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (table.getSelectedRow() == -1) {
					if (table.getRowCount() == 0) {
						JOptionPane.showMessageDialog(null, "No data to delete", "Sales Information",
								JOptionPane.OK_OPTION);
					} else {
						JOptionPane.showMessageDialog(null, "Select a row to delete", "Sales Information",
								JOptionPane.OK_OPTION);
					}
				} else {
		...
		table = new JTable();
		table.setModel(new DefaultTableModel(new Object[][] { { "250", "50", "3500", "3200" }, }, new String[] {
		...
		panel_1_1_2_1.setBounds(10, 304, 186, 45);
		...
		panel_1_1_2_2.setBounds(10, 268, 186, 34);
		...
		reconfirmsale.setBounds(219, 282, 110, 20);
		panel.add(reconfirmsale);
		reconfirmsale.setColumns(10);

		total = new JTextField();
		total.setBounds(219, 237, 110, 20);
		panel.add(total);
		total.setColumns(10);

		JLabel totall = new JLabel("");
		totall.setIcon(new ImageIcon(Sales.class.getResource("/BeveragesIcons/sales background.jpg")));
		totall.setBounds(0, 0, 775, 407);
		panel.add(totall);

		JLabel lblNewLabel_3 = new JLabel("New label");
		lblNewLabel_3.setIcon(new ImageIcon(Sales.class.getResource("/BeveragesIcons/sales background.jpg")));
