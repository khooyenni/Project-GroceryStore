...
public class RegisterFirst extends JFrame {
	...
	public RegisterFirst() {
		...
		Unametxt.setBounds(44, 156, 265, 22);
		panel.add(Unametxt);
		...
		ResetBtn.setBounds(27, 359, 144, 22);
		panel.add(ResetBtn);
		...
		btnBackToLogin.setBounds(27, 323, 144, 25);
		...
		btnSubmit.setBounds(27, 296, 94, 25);
		panel.add(btnSubmit);
		
		JLabel lblNewLabel_1 = new JLabel("");
		lblNewLabel_1.setFont(new Font("Tahoma", Font.BOLD, 8));
		lblNewLabel_1.setIcon(new ImageIcon(RegisterFirst.class.getResource("/BeveragesIcons/register customer.png")));
		lblNewLabel_1.setBounds(-14, 19, 442, 384);
		panel.add(lblNewLabel_1);
		
		JLabel lblNewLabel_2 = new JLabel("");
		lblNewLabel_2.setIcon(new ImageIcon(RegisterFirst.class.getResource("/BeveragesIcons/register background .jpg")));
		lblNewLabel_2.setBounds(-21, 0, 528, 432);
		panel.add(lblNewLabel_2);
		
		JLabel lblNewLabel_3 = new JLabel("");
		lblNewLabel_3.setIcon(new ImageIcon(RegisterFirst.class.getResource("/BeveragesIcons/register background .jpg")));
		lblNewLabel_3.setBounds(494, 0, 479, 432);
