...
class ProductAdmin extends JFrame {
	...
	public ProductAdmin(String p, String p2, String p3, String p4, String p5, String p6) { // constructor with arguments
																							// to pass the values
		this.tea = p; //
		this.coffee = p2;
		this.water = p3;
	...
	ProductAdmin() { // constructor
		...
		table.setModel(new DefaultTableModel(new Object[][] { { null, null, null, null, null, null }, },
				new String[] { "TEA", "COFFEE", "SYRUP", "JUICE", "WATER", "MILK" }));
		...
		btnNewButton.setBounds(196, 323, 89, 23);
		...
		b.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				model.addRow(new Object[] { text.getText(), cf.getText(), jc.getText(), wat.getText(), spp.getText(),
						milk.getText(),
				...
				// How to pass value/data from product description (admin page) into customer
				// page
				try {
					Order fr = new Order(p, p2, p3, p4, p5, p6); // open customer page using constructor with 5
																	// arguments
					fr.setVisible(true);
					// dispose();
				} catch (Exception ee) {
