...
public class Order extends JFrame {
	...
	public Order(String p, String p2, String p3, String p4, String p5, String p6) { // constructor with arguments to
		...
		textreceipt.setBounds(744, 307, 300, 307);
		...
		lblNewLabel_12.setIcon(new ImageIcon(Order.class.getResource("/BeveragesIcons/syrup.jpg")));
		lblNewLabel_12.setBounds(390, 89, 60, 90);
		...
		lblNewLabel.setIcon(new ImageIcon(Order.class.getResource("/BeveragesIcons/tea.png")));
		lblNewLabel.setBounds(3, 28, 86, 54);
		panel_2.add(lblNewLabel);

		JLabel lblNewLabel_1 = new JLabel("");
		lblNewLabel_1.setIcon(new ImageIcon(Order.class.getResource("/BeveragesIcons/coffee.png")));
		lblNewLabel_1.setBounds(185, 11, 79, 83);
		panel_2.add(lblNewLabel_1);

		JLabel lblNewLabel_2 = new JLabel("");
		lblNewLabel_2.setIcon(new ImageIcon(Order.class.getResource("/BeveragesIcons/milk-icon.png")));
		lblNewLabel_2.setBounds(3, 93, 60, 74);
		panel_2.add(lblNewLabel_2);

		JLabel lblNewLabel_3 = new JLabel("");
		lblNewLabel_3.setIcon(new ImageIcon(Order.class.getResource("/BeveragesIcons/orange juice.png")));
		lblNewLabel_3.setBounds(390, 16, 60, 62);
		panel_2.add(lblNewLabel_3);

		JLabel lblNewLabel_4 = new JLabel("");
		lblNewLabel_4.setIcon(new ImageIcon(Order.class.getResource("/BeveragesIcons/Bucket-Water-icon.png")));
		...
		btnAddRecore.setBounds(616, 158, 86, 23);
		...
		btnTotal.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) { // prices that updated by Admin in productAdmin class
				...
				if (itemcost[6] > 160) {
					dis.setText("40%");
					double finalPrice = itemcost[6] * (0.4);
		...
		order.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (table.getSelectedRow() == -1) {
					if (table.getRowCount() == 0) {
						JOptionPane.showMessageDialog(null, "order  confirmed", "order System", JOptionPane.OK_OPTION);
					}
				}
		...
		btnNewButton_1.setBounds(616, 137, 79, 17);
		...
		lblNewLabel_5_1_1.setBounds(621, 189, 74, 23);
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (itemcost[6] > 160) { // if the price more than RM160 the receipt will show both subtotal and total
					...
					("\n==================RECEIPT==================" + "\n"
							...
							" \n Subtotal Amount :" + itotal + // without discount

					" \n Total Amount : \t" + subtotall + // with discount
					"\n***********************************************************\t" +
					...
					Sales obj = new Sales();
					obj.my_updatee(str, totall);

				} else // if the price less than RM160 receipt will show total price ONLY
					textreceipt.append("\n==================RECEIPT==================" + "\n"
							+ "\n========VANI's Non- Alcholic Beverage Shop===========\t" +

							" \n Total Amount : \t" + itotal + // without discount
				...
				Sales obj = new Sales(); // create new object for sales
		...
		JButton btnNewButton_5 = new JButton("Upload"); // Upload Button
		...
		JButton btnNewButton_6 = new JButton("back"); // Back Button
		...
		lblNewLabel_7.setIcon(
				new ImageIcon("C:\\Users\\Asus\\Desktop\\project picture (icon)\\customer orddr background.jpg"));
		lblNewLabel_7.setBounds(0, -58, 937, 423);
		panel.add(lblNewLabel_7);

		JLabel lblNewLabel_8 = new JLabel("New label");
		lblNewLabel_8.setIcon(
				new ImageIcon("C:\\Users\\Asus\\Desktop\\project picture (icon)\\customer orddr background.jpg"));
		lblNewLabel_8.setBounds(0, 263, 788, 246);
		panel.add(lblNewLabel_8);

		JLabel lblNewLabel_9 = new JLabel("New label");
		lblNewLabel_9.setIcon(
				new ImageIcon(Order.class.getResource("/BeveragesIcons/customer orddr background.jpg")));
		lblNewLabel_9.setBounds(530, -80, 561, 431);
		panel.add(lblNewLabel_9);

		JLabel lblNewLabel_10 = new JLabel("New label");
		lblNewLabel_10.setIcon(
				new ImageIcon(Order.class.getResource("/BeveragesIcons/customer orddr background.jpg")));
		lblNewLabel_10.setBounds(550, 183, 551, 339);
		panel.add(lblNewLabel_10);

		JLabel lblNewLabel_11 = new JLabel("New label");
		lblNewLabel_11.setIcon(
				new ImageIcon(Order.class.getResource("/BeveragesIcons/customer orddr background.jpg")));
		lblNewLabel_11.setBounds(530, 447, 568, 189);
		panel.add(lblNewLabel_11);

		JLabel lblNewLabel_13 = new JLabel("");
		lblNewLabel_13.setIcon(
				new ImageIcon(Order.class.getResource("/BeveragesIcons/customer orddr background.jpg")));
		lblNewLabel_13.setBounds(0, 486, 594, 171);
