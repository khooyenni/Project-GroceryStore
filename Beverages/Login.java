...
public class Login extends JFrame {
	...
	public Login() {
		...
		lblNewLabel_2.setBounds(306, 207, 444, 26);
		panel.add(lblNewLabel_2);
		
		JLabel lblNewLabel_3 = new JLabel("New label");
		lblNewLabel_3.setIcon(new ImageIcon(Login.class.getResource("/BeveragesIcons/Admin login icon.png")));
		lblNewLabel_3.setBounds(233, 283, 116, 128);
		panel.add(lblNewLabel_3);
		
		JLabel lblNewLabel_4 = new JLabel("New label");
		lblNewLabel_4.setIcon(new ImageIcon(Login.class.getResource("/BeveragesIcons/customer log in icon.png")));
		...
		lblNewLabel_1.setIcon(new ImageIcon(Login.class.getResource("/BeveragesIcons/main page background.jpg")));
		lblNewLabel_1.setBounds(-165, 0, 1118, 633);
